...
This is a course in Python for people who work in finance.
...
* Week 1 (Pandas and Data Description)

Get spreadsheet type data and perform corporate finance related tasks.
...
- Look at actively vs passively managed ETFs (ARKK vs SPY).
- Look at sector vs broad index ETFs.
- Look at leveraged vs non-leveraged ETFs.
